...
Sơ đồ use case chi tiết của Notification Service:

\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth,height=0.55\textheight,keepaspectratio]{images/usecase-tv4.png}
  \caption{Sơ đồ use case chi tiết Notification Service}
  \label{fig:usecase-tv4}
\end{figure}
...
Dưới đây là hình ảnh các giao diện tương ứng trên ứng dụng di động và hệ thống email:
...
\begin{figure}[H]
  ...
  \begin{minipage}[b]{0.45\textwidth}
    ...
    \caption{Giao diện danh sách thông báo}
    \label{fig:ui-notification}
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=0.85\textwidth]{images/email-verification.png}
    \caption{Email xác minh tài khoản}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{images/email-notification.png}
  \caption{Email thông báo hệ thống}
