...
\begin{titlepage}
  ...
  \begin{center}
    ...
    \begin{tabular}{r l}
      ...
      \textbf{Thành viên thực hiện:} & \textit{Lại Xuân Hiếu -- B22DCCN309} \\[6pt]
    \end{tabular}
...
\section{Lại Xuân Hiếu -- AI tạo podcast: \texttt{ai-service} và \texttt{content-service}}
\label{sec:phase3-ai-content}

\subsection{Phạm vi phụ trách}

Lại Xuân Hiếu phụ trách luồng creator tạo podcast/show bằng AI và phần lưu trữ nội dung nghe được trong Content Service. Phạm vi bao gồm hai service chính:
...
\begin{table}[H]
\centering
\caption{Tổng hợp đầu ra Phase 3 -- AI + Content}
...
Chương này tách rõ kết quả chung của nhóm và kết quả riêng của phần cá nhân: Lại Xuân Hiếu -- AI tạo podcast. Phần triển khai local được giữ ở mức tổng quát, còn bảng kết quả, kiểm thử và số liệu minh chứng tập trung vào cụm AI + Content.
...
\begin{table}[H]
\centering
\caption{Kết quả cá nhân -- AI + Content}
...
\hline
Cụm phụ trách & AI + Content \\
\hline
Chức năng đã hoàn thành & Chat-create, production plan, job tạo show, ghi show/episode sang Content DB, home feed, show detail, episode detail, player transcript và bookmark. \\
\hline
Minh chứng chính & API AI/Content, AI DB, Content DB, màn hình create, My Shows, show detail và player. \\
\hline
\end{tabularx}
\end{table}
...
\caption{Bảng test case cá nhân -- AI + Content}
\label{tab:test-case}\\
\hline
...
\begin{table}[H]
\centering
\caption{Số liệu demo cá nhân -- AI + Content}
...
\begin{itemize}[leftmargin=2cm]
  \item Luồng AI phụ thuộc API key, quota, latency và chất lượng phản hồi của provider.
  \item TTS, transcript alignment và upload audio cần chạy bất đồng bộ nên cần cơ chế theo dõi job chi tiết hơn.
  \item Cần bổ sung prompt versioning, evaluation và cache kết quả nếu triển khai production.
\end{itemize}
...
\noindent
\textit{Kết thúc bản báo cáo cá nhân -- Lại Xuân Hiếu -- AI tạo podcast.}
